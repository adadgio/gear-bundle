...
module.exports = function(RED) {
    ...
    function BugzNode(n) {
        ...
        this.onexit = (n.onexit === null || typeof n.onexit === "undefined") ? false : n.onexit;
        ...
        this.on('input', function (msg) {
            ...
            // analyse something like this '[43567][ERR] Test for debug'
            var match,
                expr   = '\\[([a-z0-9]+)\\]\\[([a-z0-9]+)\\]\\[([a-z0-9]+)\\]\\s+(.*)',
                regexp = new RegExp(expr, "gi");

            var match = regexp.exec(msg.payload);
            var color = '#ccc';
            ...
            if (null === match) {
                ...
                //     obj: null,
                //     typ: 'EXT',
                //     msg: 'Script exit', // msg.payload.toString(),
                //     grp: 'stdreturn',
                //     col: 'red',
                // };
                
                // dont push, its just the script exit (should be!)
                // if (this.onexit === true) {
                //     output.push(a);
                // }
    ...
    RED.nodes.registerType('bugz', BugzNode);
    ...
    function sendDebug(msg) {
        ...
        RED.comms.publish("xdebugz",msg);
    }

    BugzNode.logHandler = new events.EventEmitter();
    BugzNode.logHandler.on("log",function(msg) {
        if (msg.level === RED.log.WARN || msg.level === RED.log.ERROR) {
            sendDebug(msg);
        }
    });
    RED.log.addHandler(BugzNode.logHandler);
