...
module.exports = {
    ...
    // '/Library/WebServer/home/symfony/360medical-v3/app/data/nodered'
    userDir: '%user_dir%',

    // Node-RED scans the `nodes` directory in the install directory to find nodes.
    // The following property can be used to specify an additional directory to scan.
    // '/Library/WebServer/home/symfony/360medical-v3/app/data/nodered/nodes'
    nodesDir: '%nodes_dir%',
    ...
    //httpAdminAuth: {user:"360medical",pass:"$2a$08$GmVpyw7eppmSOtX.fy/2Lu2yjcoiqLemzrNOhXE.EFHRQjy3nu2Ku"},
    adminAuth: %admin_auth%,
    // adminAuth: {
    //     type: "credentials",
    //     users: [{
    //         username: "360medical",
    //         password: "$2a$08$GmVpyw7eppmSOtX.fy/2Lu2yjcoiqLemzrNOhXE.EFHRQjy3nu2Ku",
    //         permissions: "*"
    //     }]
    // },
